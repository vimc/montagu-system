...
Run `./dev.sh`. This runs up the proxy along with the apis and portals, in order to manually test links, logins etc. 
Optionally include 'data' parameter (`./dev.sh data`) to include generating Montagu test data, including test user account.
